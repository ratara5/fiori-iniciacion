		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#ratara5invoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ratara5invoices-display": {
								"semanticObject": "ratara5invoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ratara5.invoices",
									"url": sap.ui.require.toUrl("ratara5/invoices")
								}
							}
						}
					}
